    ...
    <div>
      ...
      >
        ...
        >
          ...
          <Divider />
          <div className="w-full flex justify-between items-center p-3 flex-row-reverse">
            <Typography className="w-fit px-3 h-6 bg-gray-300 rounded-2xl text-black items-center justify-center text-center">
              PDF برجاء رفع العقد بصيغة{" "}
            </Typography>
            <Button
              component="label"
              role={undefined}
