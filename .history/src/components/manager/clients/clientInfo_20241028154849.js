...
function ClientInfo({ clients, isRvAllowed, timeline }) {
  ...
  return (
    <div className="w-full h-full p-3 border mt-2 border-gray-300 rounded-2xl relative">
      {!isEdit ? (
        ...
        <div className="w-full flex flex-row gap-2 ">
          <Button
            ...
            color="success"
            size="small"
            className="!absolute z-40 -top-3 right-4 h-6 "
            startIcon={<SaveIcon />}
            onClick={handleSave}
          ...
          <Button
            ...
            color="info"
            size="small"
            className="!absolute -top-3 right-24 h-6 "
      ...
      >
        <Box sx={style} className="flex flex-row justify-between">
          <Typography id="modal-modal-title" variant="h6" component="h2">
            Are u sure to save your edits?
          </Typography>
          <div className="w-full flex justify-end flex-row items-center gap-1">
            {" "}
            <Button
              variant="contained"
              color="success"
