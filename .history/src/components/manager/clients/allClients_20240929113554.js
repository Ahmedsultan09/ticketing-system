...
function AllClients() {
  ...
  return (
    <div className="w-full h-full ">
      {" "}
      <div className="w-full bg-white flex flex-row items-center justify-between p-4 border-b border-gray-400">
        <Header
          title="All Titles"
          description="Here you can find all clients that has been added recently."
          btnComponent={<Button onClick={handleOpen}> Add Client </Button>}
        />
      </div>
      <Box
        sx={{
