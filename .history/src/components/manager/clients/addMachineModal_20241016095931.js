...
export default function AddMachineModal({
  ...
  const handleExistingMachine = (e) => {
    setExistingMachine(e.target.value);
  };
  const handleSearch = () => {
    setIsLoading(true);
    ...
    if (Object.keys(matchedMachine).length > 0) {
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div
            className="w-full px-4 py-2 flex lg:flex-row flex-col lg:justify-between justify-center  items-center border border-gray-400 rounded-xl"
            dir="rtl"
          >
