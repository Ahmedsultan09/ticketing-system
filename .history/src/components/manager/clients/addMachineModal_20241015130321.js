...
function ChildModal({ closeMainModal, handleAddMachine }) {
  ...
  return (
    <>
      <div className="w-full flex items-center justify-center h-11 mt-2 gap-3">
        {" "}
        <Button variant="contained" color="success" onClick={handleAddMachine}>
          Add Machine
        </Button>
  ...
  return (
    <div>
      ...
      >
        ...
        >
          <div
            className="w-full px-4 py-2 flex flex-row justify-between items-center border border-gray-400 rounded-xl"
            dir="rtl"
          >
            ...
            <div>
              ...
              <Radio
                {...controlProps("No")}
                color="error"
                onClick={() => setExistingMachine(false)}
              />
            </div>
          </div>

          {isExistingMachine && <div>Hello</div>}
          {!isExistingMachine && (
