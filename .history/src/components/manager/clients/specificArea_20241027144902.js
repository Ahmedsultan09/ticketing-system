...
function SpecificArea() {
  ...
  useEffect(() => {
    const currentGovDetails = specificClient?.governorates?.find((gov) => {
      return gov.id === currentGovID;
    });
    setCurrentGov(currentGovDetails);
    console.log(currentGov);
  }, [currentGovID, governorates, currentGov, specificClient]);
  ...
  return (
    <div className="container">
      ...
      <div className="w-full mt-4" dir="rtl">
        ...
        <div className="container min-h-[50dvh] border border-gray-200 rounded-lg mb-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 items-center mt-4">
          {isLoading ? (
