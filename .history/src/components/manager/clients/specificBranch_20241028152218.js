...
function SpecificBranch() {
  ...
  return (
    <div className="container">
      ...
      <ClientInfo clients={specificClient} timeline={specificClient.timeline} />
      <div className="w-full mt-4" dir="rtl">
        ...
        <div className="container min-h-[50dvh] border border-gray-200 rounded-lg mb-3 flex justify-center items-center flex-wrap gap-4 mt-4">
          {isLoading ? (
