...
export default function AddClientModal({
  ...
  const [annualPeriods, setAnnualPeriods] = useState({
    id: 1,
    startDate: "",
    endDate: "",
  });
  ...
  const [quarterPeriods, setQuarterPeriods] = useState([
    { id: 1, startDate: "", endDate: "" },
    { id: 2, startDate: "", endDate: "" },
  ...
  useEffect(() => {
    console.log(annualPeriods);
    console.log(semiAnnualPeriods);
  }, [annualPeriods, semiAnnualPeriods]);
                    ...
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      ...
                      >
                        <DatePicker
                          ...
                          value={dateValue}
                          onChange={(newValue) =>
                            setSemiAnnualPeriods([
                              ...semiAnnualPeriods,
                              { id: 1, startDate: newValue },
                            ])
                          }
                          sx={{ width: "100%", pt: 0 }}
                        />
