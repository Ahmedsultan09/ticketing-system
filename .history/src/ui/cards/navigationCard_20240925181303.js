...
function NavigationCard({ name, path, color, children }) {
  return (
    <Paper className="w-full h-full p-11 bg-gradient-to-tl bg-violet-700">
      <div className="min-w-1/4 max-w-full h-11 border border-gray-300 rounded-lg flex items-center flex-1 relative">
        {" "}
