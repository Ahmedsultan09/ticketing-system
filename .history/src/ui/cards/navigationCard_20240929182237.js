  ...
  return (
    <Card className="w-full max-w-3xl relative" dir="rtl">
      <CardContent className="p-0">
        ...
        {children && (
          <div className="absolute bottom-2 h-9 bg-red-700 px-2 text-white left-4 flex items-center hover:bg-red-800 rounded-lg z-10 transition-colors duration-300 cursor-pointer">
            {" "}
            {children}
          </div>
        )}
