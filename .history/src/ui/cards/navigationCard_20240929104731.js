...
function NavigationCard({ name, path, color, title, count }) {
  return (
    <Card className="w-full max-w-3xl overflow-hidden" dir="rtl">
      <CardContent className="p-0">
        ...
        >
          ...
          <div className="flex-1 flex w-full flex-col justify-center p-8 relative z-10">
            <h2 className="text-4xl w-full font-bold text-white mb-2">
              {name}
            </h2>
