    ...
    <Card className="w-full max-w-3xl relative" dir="rtl">
      <CardContent className="p-0 w-full">
        ...
        >
          ...
          <div className="w-1/2 flex flex-col justify-center p-8 relative z-10">
            <h2 className="text-2xl w-full font-bold text-white mb-2">
              {name}
            </h2>
          </div>
          <div className="w-1/2 flex flex-col justify-center items-end p-8 relative z-10">
        ...
        {children && (
          <div className="absolute bottom-45 h-9 right-4 flex items-center  z-10  cursor-pointer">
            {" "}
            {children}
          </div>
        )}
